...
ap.add_argument('-ncat', '--num_categories', default = default_num_categories, type = int,
help ="Enter the number of desired categories")
...
help = "Desired name of the checkpoint. Will save the trained model checkpoint to disk in current working directory")
...
#Correction 1
output_size = args.num_categories #102 # This is the number of flower categories
    ...
    for images, labels in trainloader:
        ...
        if steps % print_every == 0:
            ...
            with torch.no_grad():
                ...
                valid_loss, accuracy = validation(model_chosen_arch, validloader, criterion)
...
#Correction 2: Include architecture in checkpoint
